...
function buildDisplayData() {
  ...
  return {
    ...
    settings: {
      ...
      storePromoEnabled:
        rawSettings['מבצע_מרכולית_פעיל'] ||
        'לא',

      storePromoTitle:
        rawSettings['מבצע_מרכולית_כותרת'] ||
        '🎉 מבצע השקה חגיגי',

      storePromoText:
        rawSettings['מבצע_מרכולית_טקסט'] ||
        'שתייה + חטיף או שוקולד',

      storePromoPrice:
        rawSettings['מבצע_מרכולית_מחיר'] ||
        '8 ₪ בלבד',

      storePromoUntil:
        rawSettings['מבצע_מרכולית_תוקף'] ||
        '',
